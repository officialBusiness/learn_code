...
export default class Events {
	constructor() {
		this.events = {
			...
			changeFloor(data, core, callback) {
	...
	// NPC自定义操作
	npcCustomAction(npcData) {

	}

	// 当点击(x,y)位置后自定义操作
	npcCustomActionOnClick(npcData, x, y) {

	}

	// NPC自定义事件处理
	npcCustomEffect(effect, npc) {
