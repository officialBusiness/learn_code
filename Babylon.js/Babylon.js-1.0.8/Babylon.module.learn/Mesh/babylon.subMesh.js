...
export default function SubMesh(
	...
	this._boundingInfo = new BoundingInfo(this._mesh.getVertices(), stride, verticesStart * stride, verticesCount * stride);
};
...
SubMesh.prototype.isInFrustrum = function (frustumPlanes) {
...
SubMesh.prototype.intersects = function (ray, positions, indices) {
...
SubMesh.CreateFromIndices = function(materialIndex, startIndex, indexCount, mesh) {
	...
	return new SubMesh(materialIndex, minVertexIndex, maxVertexIndex - minVertexIndex, startIndex, indexCount, mesh);
};