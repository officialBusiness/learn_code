import FreeCamera from './babylon.freeCamera.js';
...
export default function TouchCamera(name, position, scene) {
    this.name = name;
    this.id = name;
...
TouchCamera.prototype = Object.create(FreeCamera.prototype);

// Controls
TouchCamera.prototype.attachControl = function (canvas) {
