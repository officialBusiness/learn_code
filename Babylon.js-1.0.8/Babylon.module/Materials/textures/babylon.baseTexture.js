...
export default function BaseTexture(url, scene) {
	this._scene = scene;
	this._scene.textures.push(this);
};

// Members
BaseTexture.prototype.hasAlpha = false;
BaseTexture.prototype.level = 1;
BaseTexture.prototype._texture = null;

BaseTexture.prototype.onDispose = null;
