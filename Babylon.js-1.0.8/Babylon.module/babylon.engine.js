...
import VideoTexture from './Materials/textures/babylon.videoTexture.js';
...
Engine.prototype.switchFullscreen = function (element) {
	if (this.isFullscreen) {
		Tools.ExitFullscreen();
	} else {
		Tools.RequestFullscreen(element ? element : this._renderingCanvas);
	}
};
...
Engine.prototype.createDynamicTexture = function (size, noMipmap) {
	var texture = this._gl.createTexture();
...
Engine.prototype.updateDynamicTexture = function (texture, canvas) {
	this._gl.bindTexture(this._gl.TEXTURE_2D, texture);
...
Engine.prototype.updateVideoTexture = function (texture, video) {
	this._gl.bindTexture(this._gl.TEXTURE_2D, texture);
...
Engine.prototype.createRenderTargetTexture = function (size, generateMipMaps) {
	var gl = this._gl;
...
Engine.prototype.createCubeTexture = function (rootUrl, scene) {
	var gl = this._gl;
...
Engine.prototype.setTexture = function (channel, texture) {
	...
	if (internalTexture.isCube) {
		...
		if (internalTexture._cachedCoordinatesMode !== texture.coordinatesMode) {
			...
			this._gl.texParameteri(this._gl.TEXTURE_CUBE_MAP, this._gl.TEXTURE_WRAP_S, texture.coordinatesMode !== CubeTexture.CUBIC_MODE ? this._gl.REPEAT : this._gl.CLAMP_TO_EDGE);
			this._gl.texParameteri(this._gl.TEXTURE_CUBE_MAP, this._gl.TEXTURE_WRAP_T, texture.coordinatesMode !== CubeTexture.CUBIC_MODE ? this._gl.REPEAT : this._gl.CLAMP_TO_EDGE);
		}
	} else {
