import BoundingBox from './babylon.boundingBox.js';
import BoundingSphere from './babylon.boundingSphere.js';
import { Vector3 } from '../Tools/babylon.math.js';

export default function BoundingInfo(vertices, stride, verticesStart, verticesCount) {
	this.boundingBox = new BoundingBox(vertices, stride, verticesStart, verticesCount);
	this.boundingSphere = new BoundingSphere(vertices, stride, verticesStart, verticesCount);
};
...
BoundingInfo.prototype.isInFrustrum = function (frustumPlanes) {
