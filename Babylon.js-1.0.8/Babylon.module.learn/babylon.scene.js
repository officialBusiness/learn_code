...
import _Animatable from './Animations/babylon.animatable.js'
...
export default function Scene(engine) {
	...
	this.gravity = new Vector3(0, 0, -9);
...
// Animations
Scene.prototype.beginAnimation = function (target, from, to, loop, speedRatio) {
	...
	if (target.animations) {
		...
		var animatable = new _Animatable(target, from, to, loop, speedRatio);
...
// Methods
Scene.prototype.activeCameraByID = function (id) {
...
// Collisions
Scene.prototype._getNewPosition = function (position, velocity, collider, maximumRetry) {
...
Scene.prototype._collideWithWorld = function (position, velocity, collider, maximumRetry) {
...
// Picking
Scene.prototype.createPickingRay = function (x, y, world) {
	var engine = this._engine;
	...
	return Ray.CreateNew(x, y, engine.getRenderWidth() * engine.getHardwareScalingLevel(), engine.getRenderHeight() * engine.getHardwareScalingLevel(), world ? world : Matrix.Identity(), this._viewMatrix, this._projectionMatrix);
};
